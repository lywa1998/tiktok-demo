...
type User struct {
	...
	// umage at the top of the user's personal page
	BackgroundImage string `thrift:"background_image,8" form:"background_image" json:"background_image" query:"background_image"`
	// user profile
	Signature string `thrift:"signature,9" form:"signature" json:"signature" query:"signature"`
	// number of liks for videos published by user
	TotalFavorited int64 `thrift:"total_favorited,10" form:"total_favorited" json:"total_favorited" query:"total_favorited"`
	// number of videos published by user
	WorkCount int64 `thrift:"work_count,11" form:"work_count" json:"work_count" query:"work_count"`
	// number of links by this user
	FavoriteCount int64 `thrift:"favorite_count,12" form:"favorite_count" json:"favorite_count" query:"favorite_count"`
}
