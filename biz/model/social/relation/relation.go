...
type FriendUser struct {
	User    *common.User `thrift:"user,1" form:"user" json:"user" query:"user"`
	Message string       `thrift:"message,2" form:"message" json:"message" query:"message"`
	MsgType int64        `thrift:"msg_type,3" form:"msg_type" json:"msg_type" query:"msg_type"`
}
...
var FriendUser_User_DEFAULT *common.User

func (p *FriendUser) GetUser() (v *common.User) {
	if !p.IsSetUser() {
...
func (p *FriendUser) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("msg_type", thrift.I64, 3); err != nil {
		goto WriteFieldBeginError
	}
...
type RelationHandlerClient struct {
	c thrift.TClient
}

func NewRelationHandlerClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *RelationHandlerClient {
	return &RelationHandlerClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewRelationHandlerClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *RelationHandlerClient {
	return &RelationHandlerClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewRelationHandlerClient(c thrift.TClient) *RelationHandlerClient {
	return &RelationHandlerClient{
		c: c,
	}
}

func (p *RelationHandlerClient) Client_() thrift.TClient {
	return p.c
}

func (p *RelationHandlerClient) RelationAction(ctx context.Context, request *RelationActionRequest) (r *RelationActionResponse, err error) {
	var _args RelationHandlerRelationActionArgs
	_args.Request = request
	var _result RelationHandlerRelationActionResult
	if err = p.Client_().Call(ctx, "RelationAction", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *RelationHandlerClient) RelationFollowList(ctx context.Context, request *RelationFollowListRequest) (r *RelationFollowListResponse, err error) {
	var _args RelationHandlerRelationFollowListArgs
	_args.Request = request
	var _result RelationHandlerRelationFollowListResult
	if err = p.Client_().Call(ctx, "RelationFollowList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *RelationHandlerClient) RelationFollowerList(ctx context.Context, request *RelationFollowerListRequest) (r *RelationFollowerListResponse, err error) {
	var _args RelationHandlerRelationFollowerListArgs
	_args.Request = request
	var _result RelationHandlerRelationFollowerListResult
	if err = p.Client_().Call(ctx, "RelationFollowerList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *RelationHandlerClient) RelationFriendList(ctx context.Context, request *RelationFriendListRequest) (r *RelationFriendListResponse, err error) {
	var _args RelationHandlerRelationFriendListArgs
	_args.Request = request
	var _result RelationHandlerRelationFriendListResult
...
type RelationHandlerProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      RelationHandler
}

func (p *RelationHandlerProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *RelationHandlerProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *RelationHandlerProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewRelationHandlerProcessor(handler RelationHandler) *RelationHandlerProcessor {
	self := &RelationHandlerProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("RelationAction", &relationHandlerProcessorRelationAction{handler: handler})
	self.AddToProcessorMap("RelationFollowList", &relationHandlerProcessorRelationFollowList{handler: handler})
	self.AddToProcessorMap("RelationFollowerList", &relationHandlerProcessorRelationFollowerList{handler: handler})
	self.AddToProcessorMap("RelationFriendList", &relationHandlerProcessorRelationFriendList{handler: handler})
	return self
}
func (p *RelationHandlerProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type relationHandlerProcessorRelationAction struct {
	handler RelationHandler
}

func (p *relationHandlerProcessorRelationAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := RelationHandlerRelationActionArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := RelationHandlerRelationActionResult{}
...
type relationHandlerProcessorRelationFollowList struct {
	handler RelationHandler
}

func (p *relationHandlerProcessorRelationFollowList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := RelationHandlerRelationFollowListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := RelationHandlerRelationFollowListResult{}
...
type relationHandlerProcessorRelationFollowerList struct {
	handler RelationHandler
}

func (p *relationHandlerProcessorRelationFollowerList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := RelationHandlerRelationFollowerListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := RelationHandlerRelationFollowerListResult{}
...
type relationHandlerProcessorRelationFriendList struct {
	handler RelationHandler
}

func (p *relationHandlerProcessorRelationFriendList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := RelationHandlerRelationFriendListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := RelationHandlerRelationFriendListResult{}
...
type RelationHandlerRelationActionArgs struct {
	Request *RelationActionRequest `thrift:"request,1"`
}

func NewRelationHandlerRelationActionArgs() *RelationHandlerRelationActionArgs {
	return &RelationHandlerRelationActionArgs{}
}

var RelationHandlerRelationActionArgs_Request_DEFAULT *RelationActionRequest

func (p *RelationHandlerRelationActionArgs) GetRequest() (v *RelationActionRequest) {
	if !p.IsSetRequest() {
		return RelationHandlerRelationActionArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_RelationHandlerRelationActionArgs = map[int16]string{
	1: "request",
}

func (p *RelationHandlerRelationActionArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *RelationHandlerRelationActionArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationActionArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationActionArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationActionArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationActionArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *RelationHandlerRelationActionArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationActionArgs(%+v)", *p)
}

type RelationHandlerRelationActionResult struct {
	Success *RelationActionResponse `thrift:"success,0,optional"`
}

func NewRelationHandlerRelationActionResult() *RelationHandlerRelationActionResult {
	return &RelationHandlerRelationActionResult{}
}

var RelationHandlerRelationActionResult_Success_DEFAULT *RelationActionResponse

func (p *RelationHandlerRelationActionResult) GetSuccess() (v *RelationActionResponse) {
	if !p.IsSetSuccess() {
		return RelationHandlerRelationActionResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_RelationHandlerRelationActionResult = map[int16]string{
	0: "success",
}

func (p *RelationHandlerRelationActionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RelationHandlerRelationActionResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationActionResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationActionResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationActionResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationActionResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *RelationHandlerRelationActionResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationActionResult(%+v)", *p)
}

type RelationHandlerRelationFollowListArgs struct {
	Request *RelationFollowListRequest `thrift:"request,1"`
}

func NewRelationHandlerRelationFollowListArgs() *RelationHandlerRelationFollowListArgs {
	return &RelationHandlerRelationFollowListArgs{}
}

var RelationHandlerRelationFollowListArgs_Request_DEFAULT *RelationFollowListRequest

func (p *RelationHandlerRelationFollowListArgs) GetRequest() (v *RelationFollowListRequest) {
	if !p.IsSetRequest() {
		return RelationHandlerRelationFollowListArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_RelationHandlerRelationFollowListArgs = map[int16]string{
	1: "request",
}

func (p *RelationHandlerRelationFollowListArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *RelationHandlerRelationFollowListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFollowListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFollowListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFollowListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFollowListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *RelationHandlerRelationFollowListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFollowListArgs(%+v)", *p)
}

type RelationHandlerRelationFollowListResult struct {
	Success *RelationFollowListResponse `thrift:"success,0,optional"`
}

func NewRelationHandlerRelationFollowListResult() *RelationHandlerRelationFollowListResult {
	return &RelationHandlerRelationFollowListResult{}
}

var RelationHandlerRelationFollowListResult_Success_DEFAULT *RelationFollowListResponse

func (p *RelationHandlerRelationFollowListResult) GetSuccess() (v *RelationFollowListResponse) {
	if !p.IsSetSuccess() {
		return RelationHandlerRelationFollowListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_RelationHandlerRelationFollowListResult = map[int16]string{
	0: "success",
}

func (p *RelationHandlerRelationFollowListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RelationHandlerRelationFollowListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFollowListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFollowListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFollowListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFollowListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *RelationHandlerRelationFollowListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFollowListResult(%+v)", *p)
}

type RelationHandlerRelationFollowerListArgs struct {
	Request *RelationFollowerListRequest `thrift:"request,1"`
}

func NewRelationHandlerRelationFollowerListArgs() *RelationHandlerRelationFollowerListArgs {
	return &RelationHandlerRelationFollowerListArgs{}
}

var RelationHandlerRelationFollowerListArgs_Request_DEFAULT *RelationFollowerListRequest

func (p *RelationHandlerRelationFollowerListArgs) GetRequest() (v *RelationFollowerListRequest) {
	if !p.IsSetRequest() {
		return RelationHandlerRelationFollowerListArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_RelationHandlerRelationFollowerListArgs = map[int16]string{
	1: "request",
}

func (p *RelationHandlerRelationFollowerListArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *RelationHandlerRelationFollowerListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFollowerListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFollowerListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFollowerListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFollowerListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *RelationHandlerRelationFollowerListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFollowerListArgs(%+v)", *p)
}

type RelationHandlerRelationFollowerListResult struct {
	Success *RelationFollowerListResponse `thrift:"success,0,optional"`
}

func NewRelationHandlerRelationFollowerListResult() *RelationHandlerRelationFollowerListResult {
	return &RelationHandlerRelationFollowerListResult{}
}

var RelationHandlerRelationFollowerListResult_Success_DEFAULT *RelationFollowerListResponse

func (p *RelationHandlerRelationFollowerListResult) GetSuccess() (v *RelationFollowerListResponse) {
	if !p.IsSetSuccess() {
		return RelationHandlerRelationFollowerListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_RelationHandlerRelationFollowerListResult = map[int16]string{
	0: "success",
}

func (p *RelationHandlerRelationFollowerListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RelationHandlerRelationFollowerListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFollowerListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFollowerListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFollowerListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFollowerListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *RelationHandlerRelationFollowerListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFollowerListResult(%+v)", *p)
}

type RelationHandlerRelationFriendListArgs struct {
	Request *RelationFriendListRequest `thrift:"request,1"`
}

func NewRelationHandlerRelationFriendListArgs() *RelationHandlerRelationFriendListArgs {
	return &RelationHandlerRelationFriendListArgs{}
}

var RelationHandlerRelationFriendListArgs_Request_DEFAULT *RelationFriendListRequest

func (p *RelationHandlerRelationFriendListArgs) GetRequest() (v *RelationFriendListRequest) {
	if !p.IsSetRequest() {
		return RelationHandlerRelationFriendListArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_RelationHandlerRelationFriendListArgs = map[int16]string{
	1: "request",
}

func (p *RelationHandlerRelationFriendListArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *RelationHandlerRelationFriendListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFriendListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFriendListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFriendListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFriendListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *RelationHandlerRelationFriendListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFriendListArgs(%+v)", *p)
}

type RelationHandlerRelationFriendListResult struct {
	Success *RelationFriendListResponse `thrift:"success,0,optional"`
}

func NewRelationHandlerRelationFriendListResult() *RelationHandlerRelationFriendListResult {
	return &RelationHandlerRelationFriendListResult{}
}

var RelationHandlerRelationFriendListResult_Success_DEFAULT *RelationFriendListResponse

func (p *RelationHandlerRelationFriendListResult) GetSuccess() (v *RelationFriendListResponse) {
	if !p.IsSetSuccess() {
		return RelationHandlerRelationFriendListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_RelationHandlerRelationFriendListResult = map[int16]string{
	0: "success",
}

func (p *RelationHandlerRelationFriendListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *RelationHandlerRelationFriendListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationHandlerRelationFriendListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationHandlerRelationFriendListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *RelationHandlerRelationFriendListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *RelationHandlerRelationFriendListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *RelationHandlerRelationFriendListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationHandlerRelationFriendListResult(%+v)", *p)
}
